...
redis:setex(hassan..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_,500,true)
...
if msg.text and msg.type ~= "pv" and redis:get(hassan..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_) then
redis:del(hassan..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_)
if utf8.len(msg.text) > 50 then
sendMsg(msg.chat_id_,msg.id_,"•| لا يمكنك زخرفه اكثر من 50 حرف \n📑| ارسل امر زخرفه وحاول مجددا بحروف اقل")    
return false
