...
print('\27[0;31mhassan_ERROR : \27[1;31m Could Not Connect To \27[0;31mRedis\27[1;31m [\27[0;31m'..err..'\27[0m\27[1;31m] \27[0m\n\n')
print('\27[1;33mhassan_INFORMAION : \27[0;36m Run service Redis in This Command : \27[1;36m\n\n»» service redis start \27[0m\n\n\n')
local Text = "• تحذير عزيزي المطور لقد توقف البوت في السيرفر بسبب انهيار مكتبه الريدز في السيرفر بس الضغط ع موارد السيرفر يرجى اعادة تشغيله باستخدام الامر service redis start  وارساله في الترمنال "
if SUDO_ID then
...
---------------------------------------------------------------------
	...
	print('\27[0;31mhassan_ERROR : \27[1;31m Could Not Connect To \27[0;31mRedis\27[1;31m '..host..':'..port..' [\27[0;31m'..err..'\27[0m\27[1;31m] \27[0m\n\n')
	print('\27[1;33mhassan_INFORMAION : \27[0;36m Run service Redis in This Command : \27[1;36m\n\n»» service redis start \27[0m\n\n\n')
	os.exit()
