...
else redis:set(hassan.."lock_RandomRdod"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_RandomRdod"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الردود العشوائيه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:del(hassan.."lock_RandomRdod"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل الحظر والطرد    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:set(hassan.."lock_KickBan"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الحظر والطرد    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:del(hassan.."lock_KickBan"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل ردود السورس    \n• بواسطه » ❪ "..NameUser.."❫ " ) 
else redis:set(hassan.."lock_rdodSource"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل  ردود السورس    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:del(hassan.."lock_rdodSource"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل التحقق    \n• بواسطه » ❪ "..NameUser.." ❫ " )        else 
redis:del(hassan.."lock_check"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل التحقق    \n• بواسطه » ❪ "..NameUser.." ❫ " )        else
redis:set(hassan.."lock_check"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل التنظيف التلقائي    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else 

redis:del(hassan.."lock_cleaner"..msg.chat_id_)
local Cleaner = redis:smembers(hassan..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
redis:del(hassan..":SetTimerCleaner:"..msg.chat_id_..v) 
Del_msg(msg.chat_id_,v)
end
redis:del(hassan..":IdsMsgsCleaner:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل التنظيف التلقائي    \n• بواسطه » ❪ "..NameUser.." ❫ " )        else
redis:set(hassan.."lock_cleaner"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل تاك للكل    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:set(hassan.."lock_takkl"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل تاك للكل    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."lock_takkl"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل المغادره    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:set(hassan.."lock_leftgroup"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل المغادره    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:del(hassan.."lock_leftgroup"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل الحمايه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:set(hassan.."antiedit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الحمايه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."antiedit"..msg.chat_id_) 
...
else redis:set(hassan.."idphoto"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."idphoto"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الايدي بالصوره    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."idphoto"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل الرابط    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else redis:set(hassan.."lock_linkk"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الرابط    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."lock_linkk"..msg.chat_id_) 
...
else redis:set(hassan.."lock_woring"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_woring"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل التحذير    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."lock_woring"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_id"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الايدي    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."lock_id"..msg.chat_id_) 
...
redis:set(hassan.."lock_id"..msg.chat_id_,true)  
...
else redis:set(hassan.."welcome:get"..msg.chat_id_,true)  
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."welcome:get"..msg.chat_id_) then 
...
local NameUser   = Hyper_Link_Name(data)
redis:mset(
hassan.."lock_username"..msg.chat_id_,true,
hassan.."mute_gif"..msg.chat_id_,true,
hassan.."mute_photo"..msg.chat_id_,true,
hassan.."mute_audio"..msg.chat_id_,true,
hassan.."mute_voice"..msg.chat_id_,true,
hassan.."mute_sticker"..msg.chat_id_,true,
hassan.."mute_forward"..msg.chat_id_,true,
hassan.."mute_contact"..msg.chat_id_,true,
hassan.."mute_location"..msg.chat_id_,true,
hassan.."mute_document"..msg.chat_id_,true,
hassan.."lock_link"..msg.chat_id_,true,
hassan.."lock_tag"..msg.chat_id_,true,
hassan.."lock_edit"..msg.chat_id_,true,
hassan.."lock_spam"..msg.chat_id_,true,
hassan.."lock_bots"..msg.chat_id_,true,
hassan.."lock_webpage"..msg.chat_id_,true,
hassan.."mute_video"..msg.chat_id_,true,
hassan.."mute_inline"..msg.chat_id_,true
)
...
local NameUser   = Hyper_Link_Name(data)
redis:del(
hassan.."lock_username"..msg.chat_id_,
hassan.."mute_gif"..msg.chat_id_,
hassan.."mute_photo"..msg.chat_id_,
hassan.."mute_audio"..msg.chat_id_,
hassan.."mute_voice"..msg.chat_id_,
hassan.."mute_sticker"..msg.chat_id_,
hassan.."mute_forward"..msg.chat_id_,
hassan.."mute_contact"..msg.chat_id_,
hassan.."mute_location"..msg.chat_id_,
hassan.."mute_document"..msg.chat_id_,
hassan.."lock_link"..msg.chat_id_,
hassan.."lock_tag"..msg.chat_id_,
hassan.."lock_edit"..msg.chat_id_,
hassan.."lock_spam"..msg.chat_id_,
hassan.."lock_bots"..msg.chat_id_,
hassan.."lock_webpage"..msg.chat_id_,
hassan.."mute_video"..msg.chat_id_,
hassan..":tqeed_video:"..msg.chat_id_,
hassan..":tqeed_photo:"..msg.chat_id_,
hassan..":tqeed_gif:"..msg.chat_id_,
hassan..":tqeed_fwd:"..msg.chat_id_,
hassan..":tqeed_link:"..msg.chat_id_,
hassan.."mute_inline"..msg.chat_id_
)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan..":tqeed_video:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الفيديو بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:del(hassan..":tqeed_video:"..msg.chat_id_)
redis:set(hassan..":tqeed_video:"..msg.chat_id_,true)
...
local NameUser   = Hyper_Link_Name(data)
if not msg.Admin then return "•*¦ * هذا الامر يخص الادمنيه فقط  \n•" end
if not redis:get(hassan..":tqeed_video:"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل المتحركه بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:del(hassan.."mute_gif"..msg.chat_id_)
redis:set(hassan..":tqeed_gif:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح المتحركه بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else 
redis:del(hassan..":tqeed_gif:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل التوجيه بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:del(hassan.."mute_forward"..msg.chat_id_)
redis:set(hassan..":tqeed_fwd:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح التوجيه  بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else 
redis:del(hassan..":tqeed_fwd:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الروابط بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:set(hassan..":tqeed_link:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الروابط بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else 
redis:del(hassan..":tqeed_link:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الصور بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:set(hassan..":tqeed_photo:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الصور بالتقييد    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else 
redis:del(hassan..":tqeed_photo:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_twasel") then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل التواصل    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:set(hassan.."lock_twasel",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."replay"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الردود    \n• بواسطه » ❪ "..NameUser.." ❫ " )
else
redis:del(hassan.."replay"..msg.chat_id_)
...
redis:set(hassan.."replay"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_service") then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل نظام البوت خدمي    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:del(hassan.."lock_service")
...
redis:set(hassan.."lock_service",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الفشار    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_mmno3"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الفشار    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_mmno3"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الفارسيه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_pharsi"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الفارسيه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_pharsi"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الانكليزيه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_lang"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الانكليزيه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_lang"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الروابط    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_link"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الروابط    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_link"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الاضافه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_Add"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الاضافه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_Add"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل التاك (#)    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_tag"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح التاك (#)    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_tag"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل المعرفات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_username"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح المعرفات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_username"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل التعديل    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_edit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح التعديل    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_edit"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if   redis:get(hassan.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الكلايش    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_spam"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الكلايش    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_spam"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل التكرار    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_flood"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح التكرار    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_flood"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل البوتات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_bots"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح البوتات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_bots_by_kick"..msg.chat_id_)
redis:del(hassan.."lock_bots"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الاضافه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_join"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"• تم قفل الاضافه بنجاح   \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الاضافه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_join"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"• تم فتح الاضافه بنجاح   \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الماركدوان    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_markdown"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الماركدوان    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_markdown"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الويب    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_webpage"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الويب    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_webpage"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_gif"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل المتحركه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_gif"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_gif"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_game"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_game"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الالعاب    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_game"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الانلاين    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_inline"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الانلاين    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_inline"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الدردشه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_text"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الدردشه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_text"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_photo"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الصور    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_photo"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_photo"..msg.chat_id_)then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الصور    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_photo"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الفيديو    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_video"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الفيديو    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_video"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الصوت    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_audio"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الصوت    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_audio"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل البصمات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_voice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح البصمات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_voice"..msg.chat_id_)
...
if   redis:get(hassan.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الملصقات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_sticker"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الملصقات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_sticker"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الجهات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_contact"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الجهات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_contact"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_forward"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل التوجيه    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_forward"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_forward"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الموقع    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_location"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الموقع    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_location"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الملفات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_document"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الملفات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_document"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الاشعارات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_tgservice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الاشعارات    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_tgservice"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الكيبورد    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."mute_keyboard"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الكيبورد    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."mute_keyboard"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_bots_by_kick"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل البوتات بالطرد    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_bots"..msg.chat_id_,true)
redis:set(hassan.."lock_bots_by_kick"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_bots_by_kick"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(hassan.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل التثبيت    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else
redis:set(hassan.."lock_pin"..msg.chat_id_,true) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(hassan.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح التثبيت    \n• بواسطه » ❪ "..NameUser.." ❫ " ) 
else 
redis:del(hassan.."lock_pin"..msg.chat_id_)
